<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="camping.aspx.cs" Inherits="WebApplication2.camping" %>
     ...
     <form id="form1" runat="server">
        <div class="vimeo-wrapper">
         <video autoplay muted loop>
             <source src="190614_03_Camping_UHD_06.mp4" type="video/mp4" />
         </video>
            </div>
        ...
        <div>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:usersigninConnectionString6 %>" SelectCommand="SELECT * FROM [camping]"></asp:SqlDataSource>
