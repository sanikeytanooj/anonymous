<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kabbadi.aspx.cs" Inherits="WebApplication2.kabbadi" %>
    ...
    <form id="form1" runat="server">
        <div class="vimeo-wrapper">
         <video autoplay muted loop>
             <source src="Pardeep Narwal 8 Point Raid  Super Raid  Patna Pirates vs Haryana Steelers  Pro Kabaddi 2017.mp4" type="video/mp4" />
         </video>
            </div>
        ...
        <div>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:usersigninConnectionString8 %>" SelectCommand="SELECT * FROM [kabbadi]"></asp:SqlDataSource>
